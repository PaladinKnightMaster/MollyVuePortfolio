<template>
  <div   @click="addClass()"  class="wrapper centered selectable">
    <article class="letter">
      ...
      <div class="side text-center">
        ...
        <p>
          <button class="btn bg-dark text-light fs-2 font-1" id="sendLetter">Contact</button>
        </p>
      </div>
    </article>
...
export default {
  ...
  setup(props) {
    ...
    return {
      editable,
      addClass() {
        document.body.classList.toggle("sent");
      },
    };
  },
};
