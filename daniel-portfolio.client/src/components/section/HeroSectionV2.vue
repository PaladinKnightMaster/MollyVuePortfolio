<template>
  ...
  <div
    ...
    <div class="video-container position-absolute d-flex justify-content-center">
      <video src="src\assets\img\pexels-tima-miroshnichenko-5647328(1).mp4" width="200" height="1004" object-fit="cover"
        loop muted autoplay class="object-fit"></video>
    ...
    <section class="locomotive-section container-fluid" :style="{ transform: `translateY(-${scrollY}px)` }">
      <div class="row justify-content-between w-100">
        ...
        <div id="heroText" class="col-md-6 text-end text-light pe-5">
